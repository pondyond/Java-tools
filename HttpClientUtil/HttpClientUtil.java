...
public class HttpClientUtil {
    ...
    public static String doGet(String url, MapString, String params){
        return doGet(url, params,CHARSET);
    }
    public static String doPost(String url, MapString, String params){
    ...
    public static String doGet(String url,MapString,String params,String charset){
        ...
        try {
            if(params != null && !params.isEmpty()){
                ListNameValuePair pairs = new ArrayListNameValuePair(params.size());
    ...
    public static String doPost(String url,MapString,String params,String charset){
        ...
        try {
            ListNameValuePair pairs = null;
            if(params != null && !params.isEmpty()){
                pairs = new ArrayListNameValuePair(params.size());
                for(Map.EntryString,String entry  params.entrySet()){
                    String value = entry.getValue();
                    if(value != null){
                        pairs.add(new BasicNameValuePair(entry.getKey(),value));
